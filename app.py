...
def main():
    ...
    if selected == "Tutorial":
        ...
        # pdf_display = f'<iframe src="data:application/pdf;base64,{base64_pdf}" width="1280" height="1280" type="application/pdf"></iframe>'
        pdf_display = f'''<iframe src="data:application/pdf;base64,{base64_pdf}#toolbar=0&view=fitH" width="1280" height="1280" style="border: none;"></iframe>'''
